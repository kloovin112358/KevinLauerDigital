...
const ProfessionalHistoryTimeline = () => (
    <VerticalTimeline className="mt-3 mb-5" layout={'2-columns'} lineColor={"lightgrey"} animate={false}>
...
export default ProfessionalHistoryTimeline;